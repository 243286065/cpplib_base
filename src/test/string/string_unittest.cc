...
TEST(StringTest, StartsWith) {
	...
	EXPECT_TRUE(StartsWith("123A34dsad_dsad@32131", "123a34Dsad", base::CompareCase::INSENSITIVE_ASCII));
	EXPECT_FALSE(StartsWith("123A34dsad_dsad@32131", "123a34dsad", base::CompareCase::SENSITIVE));
	EXPECT_TRUE(StartsWith(L"123A34dsad_dsad@32131", L"123a34Dsad", base::CompareCase::INSENSITIVE_ASCII));
	EXPECT_FALSE(StartsWith(L"123A34dsad_dsad@32131", L"123a34dsad", base::CompareCase::SENSITIVE));
}
...
TEST(StringTest, EndsWith) {
	...
	EXPECT_TRUE(EndsWith("123A34dsad_dsad@32131", "_DsaD@32131", base::CompareCase::INSENSITIVE_ASCII));
	EXPECT_FALSE(EndsWith("123A34dsad_dsad@32131", "_DsaD@32131", base::CompareCase::SENSITIVE));
	EXPECT_TRUE(EndsWith(L"123A34dsad_dsad@32131", L"_DsaD@32131", base::CompareCase::INSENSITIVE_ASCII));
	EXPECT_FALSE(EndsWith(L"123A34dsad_dsad@32131", L"_DsaD@32131", base::CompareCase::SENSITIVE));
}
